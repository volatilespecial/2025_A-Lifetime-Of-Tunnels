...
static void init(void) {
  ...
  initText(&_textTexId, 
  "Font: SourceSerif4\n\n"
  "Texture: Created using Concrete 033 from ambientCG.com licensed under the Creative Commons CC0 1.0 Universal License.\n\n"
  "Teddybear toy : This work is based on \"Teddybear toy\" by assetfactory licensed under SKETCHFAB Standard.\n\n"
  "Crib : This work is based on \"Crib\" by gloryfish licensed under CC-BY-4.0.\n\n"
    );
}
