...
static void init(void) {
  ...
  _quad = gl4dgGenQuadf();
  initText(&_textTexId,
  "Stylized Tree : This work is based on \"Stylized Tree\" by yonimantz licensed under CC-BY-4.0.\n\n"
  "Kid toy low poly : This work is based on \"Kid toy low poly\" by assetfactory licensed under SKETCHFAB Standard.\n\n"
  "Wooden Toy Train : This work is based on \"Wooden Toy Train\" by SmolShadyStudios licensed under CC-BY-4.0.\n\n"
  "Blackboard : This work is based on \"Blackboard\" by Dandi8 licensed under CC-BY-4.0.\n\n"
  "Bookshelf, Dark Wood w/ books : This work is based on \"Bookshelf, Dark Wood w/ books\" by Tigrotto licensed under CC-BY-4.0.\n\n"
    );
}
