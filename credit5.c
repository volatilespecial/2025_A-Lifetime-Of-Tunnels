...
static void init(void) {
  ...
  _quad = gl4dgGenQuadf();
  initText(&_textTexId,
  "Anime school desk : This work is based on \"Anime school desk\" by Birp20 licensed under SKETCHFAB Standard\n\n"
  "Office Computer : This work is based on \"Office Computer\" by sebodeweb licensed under CC-BY-4.0.\n\n"
  "Office-Desk : This work is based on \"Office-Desk\" by gzezel licensed under CC-BY-4.0.\n\n"
  "Beach Ball : This work is based on \"Beach Ball\" by MaggaModels licensed under CC-BY-4.0.\n\n"
  "Beach Chair : This work is based on \"Beach Chair\" by Akshat licensed under CC-BY-4.0.\n\n"
    );
}
