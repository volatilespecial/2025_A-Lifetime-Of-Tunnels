...
static void init(void) {
  ...
  _quad = gl4dgGenQuadf();
  initText(&_textTexId,
  "Palm tree : This work is based on \"Palm tree\" by galaxxxy licensed under CC-BY-4.0.\n\n"
  "Beach Umbrella : This work is based on \"Beach Umbrella\" by stealth86 licensed under CC-BY-4.0.\n\n"
  "Wooden Coffin : This work is based on \"Wooden Coffin\" by wolfgar74 licensed under CC-BY-4.0.\n\n"
  "Wooden Cross : This work is based on \"Wooden Cross\" by RubaQewar licensed under CC-BY-4.0.\n\n"
  "Nostalgic Memories : This work is based on \"Nostalgic Memories\", a music by Clavier Clavier licensed under Pixabay Content License."
    );
}
